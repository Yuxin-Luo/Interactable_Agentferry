"""Reference code copy — DO NOT MODIFY for production logic.

Origin:
  Source: Reference/code/MonkeyMeme-Gesture_Tracker/gesture-tracker.py
  Origin license: not declared in repository; treated as MIT-like (open-source
                  reference). Original author rights acknowledged.
Purpose in this project:
  Reference implementation of hand-landmark gesture classification
  (Thumbs Up / Pointing / Thinking / Neutral) used to inform the design of
  src/vision/gesture_classifier.py. Kept verbatim for traceability.

This file is NOT a runtime dependency — production code lives in src/vision/.
"""
